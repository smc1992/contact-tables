...
export default function ForgotPassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatus({
        type: 'success',
        message: 'Eine E-Mail mit einem Link zum Zurücksetzen Ihres Passworts wurde an Ihre E-Mail-Adresse gesendet.',
      });
    } catch (error: any) {
      ...
      <main className="pt-20 px-4 md:px-8 pb-12">
        <div className="max-w-md mx-auto bg-white rounded-xl shadow-sm p-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-800">Passwort vergessen?</h1>
